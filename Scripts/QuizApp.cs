...
public class QuizApp : MonoBehaviour
{
    ...
    private Transform quizEntry;

    // New Quiz
    private Transform quizNameInput;

    // Quiz Details
    private Transform qnContainer;
    private Transform qnEntry;

    // Question Details
    private Transform qnDescription;
    private Transform opContainer;
    private Transform opToggle;

    // Preview
    private Transform previewQn;
    private Transform previewLabel;
    private Transform previewOption;

    // Result
    private Transform result;
    private Button submitBtn;
    private Button nextBtn;
    private Transform previewScore;
